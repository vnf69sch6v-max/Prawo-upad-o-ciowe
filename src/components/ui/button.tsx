        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    {
                        // Variants
                        'bg-purple-600 hover:bg-purple-500 text-white focus:ring-purple-500': variant === 'primary',
                        'bg-[var(--bg-card)] border border-[var(--border-color)] hover:border-purple-500/50 text-[var(--text-primary)]': variant === 'secondary',
