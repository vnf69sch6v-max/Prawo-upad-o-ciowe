        ...
        <div className="lex-card">
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    className="w-full px-4 py-3 bg-[var(--bg-hover)] border border-[var(--border-color)] rounded-xl focus:border-purple-500 focus:outline-none"
                />
            </div>
            ...
            <div className="mb-4">
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        placeholder="0"
                        min="0"
                        className="flex-1 px-4 py-3 bg-[var(--bg-hover)] border border-[var(--border-color)] rounded-xl focus:border-purple-500 focus:outline-none"
                    />
            ...
            <label className="flex items-center gap-2 mb-6 cursor-pointer">
                <input
                    ...
                    className="w-4 h-4 rounded border-[var(--border-color)] bg-[var(--bg-hover)] text-purple-500 focus:ring-purple-500"
                />
                ...
                <div className="p-4 bg-[var(--bg-hover)] rounded-xl space-y-3">
                    ...
                    {activePreset?.basis && (
                        <p className="text-xs text-[var(--text-muted)]">
                            Podstawa prawna: <span className="text-purple-400">{activePreset.basis}</span>
                        </p>
                    )}
    ...
    return (
        <div className="lex-card">
            ...
            <div className="p-4 bg-[var(--bg-hover)] rounded-xl space-y-3">
                ...
                <p className="text-xs text-[var(--text-muted)]">
                    Podstawa: <span className="text-purple-400">{rate.basis}</span>
                </p>
            </div>
        </div>
    );
