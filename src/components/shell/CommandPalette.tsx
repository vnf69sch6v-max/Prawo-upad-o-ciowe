...
const COMMANDS: Cmd[] = [
    ...
    { id: 'ind-korelacje', group: 'Wskaźniki', label: 'Zależności / korelacje makro', sub: 'Gospodarka', keywords: 'korelacje zależności co z czym macierz pearson', href: '/gospodarka?tab=korelacje', icon: LineChart },
