...
const COMMANDS: Cmd[] = [
    ...
    { id: 'ind-finanse', group: 'Wskaźniki', label: 'Finanse publiczne (dług, deficyt, 10Y)', sub: 'Gospodarka', keywords: 'dług publiczny deficyt budżet rentowność obligacje 10y maastricht', href: '/gospodarka?tab=finanse', icon: Landmark },
