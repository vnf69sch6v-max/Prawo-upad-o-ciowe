...
// Login form component - separated to use Suspense for useSearchParams
function LoginForm() {
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-6 sm:mb-8">
                    <h2 className="text-xl sm:text-2xl font-serif font-bold text-[#1a365d]">Witaj z powrotem</h2>
                    <p className="text-gray-500 mt-2 text-sm sm:text-base">Zaloguj się do swojego konta</p>
                </div>
