...
export default function SamorzadPage() {
    ...
    return (
        <div className="mk-fade-in space-y-6">
            <div>
                <h1 className="text-3xl font-extrabold tracking-tight text-mk-text">Samorząd / Usługi publiczne</h1>
                <p className="mt-1 text-sm text-mk-muted">Dane SMUP — System Monitorowania Usług Publicznych (GUS). Drążenie: obszar → usługa → wskaźnik.</p>
            </div>
