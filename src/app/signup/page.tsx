        ...
        <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--bg-primary)' }}>
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-[var(--text-muted)] mt-2">Zacznij swoją drogę do sukcesu prawniczego</p>
                </div>
                                ...
                                <div className="mt-3 space-y-1">
                                    {[
                                        ...
                                        <div key={key} className="flex items-center gap-2 text-xs">
                                            ...
                                            <span className={passwordChecks[key as keyof typeof passwordChecks] ? 'text-green-400' : 'text-[var(--text-muted)]'}>
                                                {label}
                                            </span>
                                        </div>
                                    ))}
                ...
                <p className="text-center text-xs text-[var(--text-muted)] mt-6">
                    ...
                    <a href="#" className="underline">Regulamin</a> i{' '}
