...
function ProPlanCard({ selected, onSelect }: PlanCardProps) {
    return (
        <div
            onClick={onSelect}
            className={cn(
                ...
                selected
                    ? "bg-white/15 border-[#b8860b]"
                    : "bg-white/10 border-[#b8860b]/60 hover:border-[#b8860b]"
            )}
        >
...
function SignupForm() {
    ...
    // Plan selection state - default to 'pro' if URL has ?plan=pro, otherwise 'free'
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // After registration, redirect based on plan
            if (selectedPlan === 'pro') {
            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
                <div className="w-full max-w-md">
                    ...
                    <div className="lg:hidden mb-6 space-y-3">
                        <p className="text-sm font-medium text-gray-600 text-center">Wybierz plan:</p>
                        <div className="flex gap-3">
                            ...
                            >
                                ...
                                <span className="text-sm opacity-75">0 zł</span>
                            </button>
                            <button
                                type="button"
                                ...
                                className={cn(
                                    ...
                                    selectedPlan === 'pro'
                                        ? "bg-[#1a365d] border-[#b8860b] text-white"
                                        : "bg-gray-50 border-[#b8860b]/50 text-gray-700 hover:border-[#b8860b]"
                                )}
                            >
                                <div className="absolute -top-2 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-[#b8860b] text-white text-[10px] font-semibold rounded-full flex items-center gap-1">
                                    <Crown size={10} />
                                    POLECANY
                                </div>
                                <span className="font-semibold block">Pro</span>
                                <span className="text-sm opacity-75">149 zł/rok</span>
                            </button>
                        </div>
                    </div>
